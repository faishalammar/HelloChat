...
public class Cube {
    ...
    float colorcyan[] = OpenGLColor.cyan();
    float colorblue[] = OpenGLColor.blue();
    float colorred[] = OpenGLColor.red();
    float colorgray[] = OpenGLColor.gray();
    float colorgreen[] = OpenGLColor.green();
    float coloryellow[] = OpenGLColor.yellow();
